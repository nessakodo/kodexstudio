    ...
    <div className="bg-cyber-black text-cyber-text overflow-x-hidden min-h-screen">
      ...
      <div className={`container mx-auto px-4 py-8 max-w-6xl min-h-screen flex flex-col transition-opacity duration-500 ${bootComplete ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <header className="pt-8 md:pt-16 text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12 animate-fadeInUp delay-300">
            ...
            <div className="glass-panel px-4 py-3 rounded-lg flex items-center gap-2">
              <span className="text-cyber-blue">&lt;&gt;</span>
              <span className="text-white/80">Ethical Design</span>
            </div>
            <div className="glass-panel px-4 py-3 rounded-lg flex items-center gap-2">
              <span className="text-cyber-blue">⪾</span>
              <span className="text-white/80">Digital Sovereignty</span>
            </div>
          </div>
          
          <div className="glass-panel p-6 rounded-xl mb-8 max-w-2xl mx-auto text-left animate-fadeInUp delay-400">
            <p className="text-white/80 text-sm md:text-base mb-4">
              Secure, expressive systems for the post-noise internet. Providing freelance cybersecurity, full-stack development, and mindful tech consulting with a focus on outcome-driven solutions.
            </p>
            <p className="text-cyber-blue/80 font-plex text-sm border-l-2 border-cyber-blue/30 pl-3 italic">
              "Technology that respects your autonomy and enhances your capability."
            </p>
          </div>
          
          <p className="text-cyber-blue text-sm md:text-base mb-2 animate-fadeInUp delay-500">
            Type <span className="font-plex bg-cyber-blue/10 px-2 py-0.5 rounded">help</span> to explore — or enter a command below.
          </p>
        </header>
        ...
        {/* Footer */}
        <footer className="mt-8 py-4 border-t border-cyber-blue/10">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center">
              <span className="text-white/40 text-sm mr-3">&copy; {new Date().getFullYear()} KODEX.STUDIO</span>
              <div className="flex space-x-4">
                <a href="https://github.com/nessakodo" target="_blank" rel="noopener noreferrer" className="text-cyber-text/70 hover:text-cyber-blue transition">
                ...
                <a href="https://linkedin.com/in/nessakodo" target="_blank" rel="noopener noreferrer" className="text-cyber-text/70 hover:text-cyber-blue transition">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="https://twitter.com/nessakodo" target="_blank" rel="noopener noreferrer" className="text-cyber-text/70 hover:text-cyber-blue transition">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
